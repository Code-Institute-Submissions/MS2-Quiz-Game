...
The idea of this project was to create a simple challenge quiz with an
API from OpenTrivia.
...
In the original design, what is now the â€œHomeâ€ section was the â€œAboutâ€ section and what is now the â€œworksâ€ section was the â€œhomeâ€ section, but after evaluating some user
...
2. Select â€œyour profileâ€ from the upper-right dropdown menu and select the proper repository.
...
-
- The hover effect on thebuttons was taken from https://ianlunn.github.io/Hover/
